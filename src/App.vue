...
<template>
  <div class="main">
    <el-dialog v-model="Data.dialogTableVisible" title="请选择要进入的特色小镇" width="800">
      <div class="mb-4">
    <el-button type="success" v-for="(item, index) in Data.townoptions" :key="index" @click="changeTown(item.townname)">{{item.townname}}</el-button>
  </div>
    </el-dialog>
    <keep-alive>
  ...
  <div class="music">
    <!--音乐开始controls-->
    <audio id="audio" src="https://pic-1257960926.cos.ap-guangzhou.myqcloud.com/town/202402221128889.mp3" autoplay
      loop></audio>
  </div>
</template>
<script setup>
